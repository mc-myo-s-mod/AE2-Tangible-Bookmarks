...
AE2 Tangible Bookmarks能将物品管理器模组（JEI/REI）的书签和AE2的终端连接起来。

使用AE2终端时，点击JEI或REI中的书签/收藏物品，即可直接向网络请求它们，无需再在终端搜索栏内输入对应名称。
...
JEI 和 REI 通过 AE2 的转换机制支持物品和流体数量；自定义资源需要对应的转换器。此版本不支持 EMI。
