...
JEI supports item and fluid amounts; custom resources require a compatible AE2 JEI integration converter. EMI uses registered AE2 converters. REI amount display is limited to favorites that can be converted to an item stack.
